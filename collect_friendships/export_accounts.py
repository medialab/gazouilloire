...
for t in db.find(sort=[("_id", 1)]):
    t[u"Élu au"] = "Conseil de Paris" if t["CR"] == "False" else u"Conseil régional d'IdF" if t["CP"] == "False" else "Les deux"
