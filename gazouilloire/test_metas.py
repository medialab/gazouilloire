...
try:
    ...
    t1 = Twitter(domain="api.twitter.com", api_version="1.1", format="json", auth=oauth, secure=True)
    t2 = Twitter(domain="api.twitter.com", api_version="1.1", format="json", auth=oauth2, secure=True)
except Exception as e:
    sys.exit('ERROR: Could not initiate connections to Twitter API: %s %s\n' % (type(e), e))
try:
...
t = t1.statuses.show(_id=sys.argv[1], include_entities=True, tweet_mode="extended")
pprint(t)
