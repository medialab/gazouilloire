...
# Run it directly or by giving it an optional path to a directory where to store the output
# For instance:
...
#
# It will automatically try to use pyenv to activate a virtualenv given in .python-version or
# named 'gazou-CORPUSDBNAME' otherwise, but you can also force another env as a 2nd argument like this:
...
#
# - Typical cronjobs:
# The main use of this script is to automate a daily export of all collected tweets for a corpus.
